...
HD_PWD='E:/project/FPGA/ai1/01.gate_test/01.gate_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gatetest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gatetest.tcl -notrace
