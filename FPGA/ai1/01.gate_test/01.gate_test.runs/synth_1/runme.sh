...
HD_PWD='E:/project/FPGA/ai1/01.gate_test/01.gate_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gatetest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gatetest.tcl
