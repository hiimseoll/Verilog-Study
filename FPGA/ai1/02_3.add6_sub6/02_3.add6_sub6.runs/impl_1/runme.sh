...
HD_PWD='E:/project/FPGA/ai1/02_3.add6_sub6/02_3.add6_sub6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log add6_sub6.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source add6_sub6.tcl -notrace
