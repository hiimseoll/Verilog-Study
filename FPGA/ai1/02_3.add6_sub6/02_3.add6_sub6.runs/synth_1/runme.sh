...
HD_PWD='E:/project/FPGA/ai1/02_3.add6_sub6/02_3.add6_sub6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add6_sub6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add6_sub6.tcl
