...
set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports {select_t}]
...
#set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports {carry_out}]
...
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports {cin}]
