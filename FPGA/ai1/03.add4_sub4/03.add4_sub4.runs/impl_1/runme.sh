...
HD_PWD='E:/project/FPGA/ai1/03.add4_sub4/03.add4_sub4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log add4_sub4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source add4_sub4.tcl -notrace
