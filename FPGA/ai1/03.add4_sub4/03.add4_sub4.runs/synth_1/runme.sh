...
HD_PWD='E:/project/FPGA/ai1/03.add4_sub4/03.add4_sub4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add4_sub4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add4_sub4.tcl
