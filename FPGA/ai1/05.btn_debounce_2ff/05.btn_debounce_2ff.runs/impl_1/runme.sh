...
HD_PWD='E:/project/FPGA/ai1/05.btn_debounce_2ff/05.btn_debounce_2ff.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_btn.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_btn.tcl -notrace
