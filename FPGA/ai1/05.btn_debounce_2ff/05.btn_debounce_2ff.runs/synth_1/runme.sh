...
HD_PWD='E:/project/FPGA/ai1/05.btn_debounce_2ff/05.btn_debounce_2ff.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_btn.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_btn.tcl
