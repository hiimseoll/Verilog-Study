...
HD_PWD='E:/project/FPGA/ai1/05.my_btn_debounce/05.my_btn_debounce.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_btn_debounce.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_btn_debounce.tcl -notrace
