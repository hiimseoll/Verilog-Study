...
HD_PWD='E:/project/FPGA/ai1/05.my_btn_debounce/05.my_btn_debounce.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_btn_debounce.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_btn_debounce.tcl
