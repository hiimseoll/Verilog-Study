...
module control_tower(
    ...
    wire [28:0] w_max_count = (r_mode == STOPWATCH) ? 29'd10_0 : 29'd100_0;  // tb용 축소 전 29'd10_000_000 : 29'd100_000_000;
    ...
    always @(posedge clk or posedge reset) begin
        if(reset) begin
            ...
            case(r_mode)
                ...
                PAUSE: begin
                    if(r_counter >= 29'd500_0 - 1) begin // 29'd500_000_000 - 1 tb용 축소 전
                        r_idle <= 1; 
                    end else begin
                        r_idle <= 0;
                        r_counter <= r_counter + 1;
